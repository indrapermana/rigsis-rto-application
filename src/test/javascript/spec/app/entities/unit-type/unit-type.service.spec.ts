...
describe('Service Tests', () => {
    describe('UnitType Service', () => {
        let injector: TestBed;
        let service: UnitTypeService;
        let httpMock: HttpTestingController;
        let elemDefault: IUnitType;
        beforeEach(() => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a UnitType', async () => {
            ...
            it('should update a UnitType', async () => {
                const returnedFromService = Object.assign(
                    {
                        type: 'BBBBBB'
                    },
            ...
            it('should return a list of UnitType', async () => {
                const returnedFromService = Object.assign(
                    {
                        type: 'BBBBBB'
                    },
            ...
            it('should delete a UnitType', async () => {
